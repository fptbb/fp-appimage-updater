...
<Tip>
  Run `doctor` first whenever you experience unexpected behavior. It quickly surfaces missing directories, unparseable recipes, and absent tooling before you dig deeper.
</Tip>
