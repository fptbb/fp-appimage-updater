...
Se um limite de taxa foi atingido em uma execução anterior, o app afetado é ignorado até que sua janela de nova tentativa expire - a menos que `respect_rate_limits` esteja desabilitado globalmente ou para esse app.
