...
<CardGroup cols={2}>
  ...
  <Card title="Três estratégias de atualização" icon="arrows-rotate">
    Busque atualizações em releases do GitHub ou GitLab com `forge`, uma URL estável com `direct`, ou um script shell personalizado com `script`.
  </Card>
  ...
  <Card title="Fallback de proxy do GitHub" icon="shield">
    Tenta novamente as consultas da API de releases do GitHub por meio de uma ou mais bases de proxy configuradas quando os limites de taxa são atingidos, sem fazer proxy do download real.
  </Card>
